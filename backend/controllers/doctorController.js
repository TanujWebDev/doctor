...
const doctorList = async (req, res) => {
  try {
    ...
    // Synchronize slots_booked with active appointments in DB
    for (let doc of doctors) {
      ...
      let updatedSlotsBooked = {};
      for (let app of activeAppointments) {
        const { slotDate, slotTime } = app;
      ...
      if (
        JSON.stringify(doc.slots_booked) !== JSON.stringify(updatedSlotsBooked)
      ) {
        await doctorModel.findByIdAndUpdate(doc._id, {
          slots_booked: updatedSlotsBooked,
        });
        doc.slots_booked = updatedSlotsBooked;
      }
    }
